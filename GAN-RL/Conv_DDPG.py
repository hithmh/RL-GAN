...
class Actor(object):
    def __init__(self, sess, action_dim,  learning_rate, t_replace_iter, S, S_, scope = 'Actor', action_bound = None):
        self.sess = sess
    ...
    def _build_net(self, s, scope, trainable):
        with tf.variable_scope(scope):
            ...
            net = tf.layers.conv2d(s, 200, activation=tf.nn.relu6,
...
class Critic(object):
    def __init__(self, sess, state_dim, action_dim, learning_rate, gamma, t_replace_iter, a, a_, S, S_, R, scope='Critic'):
        self.sess = sess
